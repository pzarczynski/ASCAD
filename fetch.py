...
def fetch_url(url, out: str, block_size=1024):
    ...
    with open(out, "wb") as f:
        for data in tqdm(r.iter_content(block_size), total=n_blocks, unit="KB"):
            f.write(data)
...
if __name__ == "__main__":
    ...
    url = f"https://huggingface.co/datasets/zarczynski/ASCAD/resolve/main/{filename}"
